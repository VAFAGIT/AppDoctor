        ...
        <div class="lg:gap-4 lg:flex">
            <div class="flex flex-col items-center justify-center md:py-24 lg:py-32">
                ...
                <p class="mb-8 text-2xl font-bold text-center text-gray-800 md:text-3xl">
                    <span class="text-red-500"></span> Vous n'avez pas de rendez-vous
                </p>
                <p class="mb-8 text-center text-gray-500 md:text-lg">
                
                </p>
                <!-- <button @click="BackBook" class="px-6 py-2 text-sm font-semibold text-blue-800 bg-blue-100"> </button> -->
            </div>
            <div class="mt-4 w-80">
